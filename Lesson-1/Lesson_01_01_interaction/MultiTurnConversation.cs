...
namespace Lesson_1.Lesson_01_01_interaction;

internal static class MultiTurnConversation
{
    ...
    private static async Task<(string Text, int ReasoningTokens)> Chat(string input, object[]? history = null)
    {
        ...
        {
            var errorMessage = errProp.ValueKind == JsonValueKind.Object
                && errProp.TryGetProperty("message", out var msg)
                    ? msg.GetString()
